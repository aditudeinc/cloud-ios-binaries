...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tude",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (NativeBannerAd * _Nullable)getNativeBannerAd:(NSString * _Nonnull)slot SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC4Tude14NativeBannerAd")
@interface NativeBannerAd : NSObject
@property (nonatomic, readonly) BOOL isLoaded;
@property (nonatomic, copy) void (^ _Nonnull onNativeAdLoaded)(GADNativeAd * _Nonnull);
@property (nonatomic, copy) void (^ _Nonnull onCustomFormatNativeAdLoaded)(GADCustomNativeAd * _Nonnull);
@property (nonatomic, copy) void (^ _Nonnull onNativeAdFailedToLoad)(AdFailedToLoadError * _Nonnull);
@property (nonatomic, readonly, copy) NSString * _Nonnull slotName;
- (void)preload;
- (void)preloadOnPreload:(void (^ _Nonnull)(void))onPreload;
- (void)setTargeting:(NSDictionary<NSString *, NSString *> * _Nonnull)targeting;
- (void)load:(UIViewController * _Nonnull)vc;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
@interface NativeBannerAd (SWIFT_EXTENSION(Tude)) <GADCustomNativeAdLoaderDelegate>
...
@interface NativeBannerAd (SWIFT_EXTENSION(Tude)) <GADNativeAdLoaderDelegate>
